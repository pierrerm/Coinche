...
class Team():
  def __init__(self, team_name, team_number, j1_name, j1_random, j1_cards, j2_name, j2_random, j2_cards ):
   ...
   self.players=[Player(team_number=team_number, name=j1_name, random=j1_random, cards=j1_cards, number=1+team_number),
                 Player(team_number=team_number, name=j2_name, random=j2_random, cards=j2_cards, number=3+team_number)]
